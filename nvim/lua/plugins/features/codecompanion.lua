...
-- local ollamaModel = "gpt-oss:latest"
local ollamaModel = "GandalfBaum/llama3.2-claude3.7:latest"
-- local ollamaModel = "GandalfBaum/deepseek_r1-claude3.7:latest"
...
return {
	...
	keys = {
		...
		{ "<leader>aic", "<cmd>CodeCompanionChat<CR>", desc = "AI chat", mode = { "n", "v" } },
	},
	cmd = {
		"CodeCompanion",
		"CodeCompanionChat",
