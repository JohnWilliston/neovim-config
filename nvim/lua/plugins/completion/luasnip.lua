return {
	...
	build = "make install_jsregexp", -- Always fails on Windows. Sigh.
	dependencies = {
	...
	keys = {
		...
		-- But I'm not even sure what that means. I don't think it ever worked.
	...
	config = function()
		...
		-- I don't believe this is required; seems to double up snippets.
